<header id="HeaderBi">
    <div class="Imagenes">
        <img src="Images/Biblioteca/Biblioteca1.jpg" class="Img1" alt="">
        <img src="Images/Biblioteca/Biblioteca2.jpeg" class="Img2" alt="">
        <img src="Images/Biblioteca/JulioFlorez.jpg" class="JulioFlorez" alt="">
    </div>
    <div class="Info">
...
<main id="Encargado">
    <div class="Imagen">
        <img src="Images/Biblioteca/Cecilia.png" alt="">
    </div>
    <div class="Info">
...
<main id="Frase">
    <div class="Imagen">
        <img src="Images/Biblioteca/Frase.png" alt="">
    </div>
    <div class="Info">
        <div class="Caja">
            <h5 class="Title">
...
?>
    ...
    <main class="VisualCards" id="Destacados">
        <div class="Visualizer">
            <article class="Card">
                <div class="Image">
                    <img src="Images/Biblioteca/Libros/Lib1.png" alt="">
        ...
        <div class="Elementos">
            <article class="Card">
                <div class="Image">
                    <img src="Images/Biblioteca/Libros/Lib2.png" alt="">
                    <p class="Text"> Click para observar </p>
                </div>
                <div class="Info">
                    <div class="Caja">
            ...
            <article class="Card">
                <div class="Image">
                    <img src="Images/Biblioteca/Libros/Lib3.png" alt="">
                    <p class="Text"> Click para observar </p>
                </div>
                <div class="Info">
                    <div class="Caja">
            ...
            <article class="Card">
                <div class="Image">
                    <img src="Images/Biblioteca/Libros/Lib4.png" alt="">
                    <p class="Text"> Click para observar </p>
                </div>
                <div class="Info">
                    <div class="Caja">
            ...
            <article class="Card">
                <div class="Image">
                    <img src="Images/Biblioteca/Libros/Lib5.png" alt="">
                    <p class="Text"> Click para observar </p>
                </div>
                <div class="Info">
                    <div class="Caja">
...
<main id="Importancia">
    <div class="Imagen1">
        <img src="Images/Biblioteca/Estanteria.jpg" alt="">
    </div>
    <div class="Info">
        <h5 class="Title"> 1. </h5>
        <p class="Text">
    ...
    <div class="Caja">
        <div class="Imagen">
            <img src="Images/Biblioteca/Libro.jpg" alt="">
        </div>
        <div class="Info">
            <h5 class="Title"> 3. </h5>
            <p class="Text">
    ...
    <main id="Libros">
        ...
        <div class="MainCarousel" data-cards="6" data-auto="true" data-interval="5">
            <div class="DataCarousel">
                ...
                <div class="Carousel">
                    <img src="Images/Biblioteca/Libros/Lib6.png" alt="">
                </div>
                <div class="Carousel">
                    <img src="Images/Biblioteca/Libros/Lib7.png" alt="">
                </div>
                <div class="Carousel">
                    <img src="Images/Biblioteca/Libros/Lib8.png" alt="">
                </div>
                <div class="Carousel">
                    <img src="Images/Biblioteca/Libros/Lib9.png" alt="">
                </div>
                <div class="Carousel">
                    <img src="Images/Biblioteca/Libros/Lib10.png" alt="">
                </div>
            </div>
...
<main id="Garcia">
    <div class="Autor">
        <img src="Images/Biblioteca/GarciaMarquez.jpg" alt="">
        <div class="Caja">
            <div class="Info">
    ...
    <div class="Libro">
        <img src="Images/Biblioteca/Libros/Lib11.jpg" alt="">
        <div class="Info">
    ...
    <div class="Libro Num2">
        ...
        <img src="Images/Biblioteca/Libros/Lib12.jpg" alt="">
    </div>
    <div class="Libro Num3">
        <img src="Images/Biblioteca/Libros/Lib13.jpg" alt="">
        <div class="Info">
            <h5 class="Title Min"> Cien años de soledad </h5>
            <p class="Text">
                De hecho, el inicio de esta saga ya es curioso: se acomodan en un “trozo de tierra” y fundan un pueblo:
