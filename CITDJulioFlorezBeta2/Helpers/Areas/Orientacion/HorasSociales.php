...
if (isset($_SESSION['PK_Id_User'])) {
    ...
    if ($RowRol['Name_Rol']  == 'Estudiante' && (($RowRol['Ident_User'] != 1028660884 && $RowRol['Ident_User'] != 1071163947) || $Validar == false)) {
...
?>
        <div class="Contenedor-Tabla">
            <table class="Tabla" id="TableHours">
                ...
                <tr>
                    ...
                    <th class="MaxWidht">
                        <?php
                        if ($RowRol['Name_Rol']  != 'Estudiante' || ($RowEst['Verificado_Est'] != 1 && ($RowRol['Ident_User'] == 1028660884 || $RowRol['Ident_User'] == 1071163947))) {
        ...
        if ($RowRol['Name_Rol']  != 'Estudiante' || ($RowRol['Ident_User'] == 1028660884 || $RowRol['Ident_User'] == 1071163947)) {
