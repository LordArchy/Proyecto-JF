-- Active: 1662247960966@@127.0.0.1@3306@citdjulioflorezbeta

/* ========================= Base de datos =========================*/
CREATE DATABASE CITDJulioFlorezBeta;

USE CITDJulioFlorezBeta;

/* DROP DATABASE CITDJulioFlorezBeta; */
...
INSERT INTO Estudiantes(
    Nom_Ser, Sup_Ser, ValSer_Est, FecInSer_Est, FecFinSer_Est,
    ...
    2, '2022-02-16', '0000-00-00', 3, 1, 0, 40
),(
    'Modificación y creación de la página del colegio, biblioteca, 
    comedor y orientación',
    'Orientador - Juan Carlos, Profesor - José Santana',
    2, '2022-02-16', '0000-00-00', 3, 2, 0, 40
);
...
INSERT INTO Estudiantes(
    ...
    2, '2022-04-12', '0000-00-00', 2, 3, 0, 80
),(
    'Nombre de servicio social',
    'Supervisor del servicio social del estudiante',
    'Lugar del servicio social solo si es requerido',
    1, '2022-02-16', '2022-08-04', 2, 4, 1, 80
), (
